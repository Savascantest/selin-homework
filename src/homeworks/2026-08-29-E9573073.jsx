...
const makeReview = (items) => items.map(([question, options, answer]) => ({ type: 'mcq', question, options, answer }));

const CURRENT_CURRICULUM = {
  1: {
    ...CURRICULUM[1],
    title: 'Day 1: Mixed Review — Present Tenses & Personality',
    grammar: { title: '15-Question Mixed Review', desc: 'These are familiar topics, so there is no repeated grammar explanation. Use the context to choose the best answer.', rules: [] },
    grammarExercises: makeReview([
      ['Nora usually ___ from home on Fridays.', ['works','is working','work','worked'], 0],
      ['Look! Daniel ___ toward the wrong platform.', ['walks','is walking','walk','has walked'], 1],
      ['Maya is normally calm, but today she ___ impatient.', ['is being','is','be','being'], 0],
      ['Which sentence describes a permanent quality?', ['Leo is being generous today.','Leo is generous.','Leo generous is.','Leo be generous.'], 1],
      ['The children ___ very politely at the moment.', ['behave','are behaving','behaves','behavior'], 1],
      ['A person who tells the truth is ___.', ['honest','jealous','arrogant','annoying'], 0],
      ['Rosa ___ coffee, but she is drinking tea today.', ['usually drinks','is usually drinking','drink usually','drinking'], 0],
      ['Why ___ Amir laughing now?', ['does','is','do','has'], 1],
      ['The new receptionist is relaxed and easy to talk to. She is ___.', ['easy-going','sensitive','silly','jealous'], 0],
      ['Choose the natural sentence.', ['Tara is always polite.','Tara always is polite.','Tara polite always.','Always Tara polite is.'], 0],
      ['Ben and Ava ___ dinner right now.', ['make','makes','are making','made usually'], 2],
      ['A person who believes in their ability is ___.', ['confident','annoying','arrogant','sensitive'], 0],
      ['Omar ___ his neighbours every weekend.', ['helps','is helping always','help','helping'], 0],
      ['Today the manager ___ unusually friendly.', ['is being','is always','be','does'], 0],
      ['Which sentence is correct?', ['I am understanding the rule.','I understand the rule.','I understands the rule.','I understanding the rule.'], 1]
    ])
  },
  2: {
    ...CURRICULUM[2],
    title: 'Day 2: Mixed Review — Everyday Verb Patterns',
    grammar: { title: '15-Question Mixed Review', desc: 'No new rule today. Retrieve the verb patterns from memory and check how each phrase works in context.', rules: [] },
    grammarExercises: makeReview([
      ['Mina is waiting ___ the bus.', ['to','for','at','with'], 1],
      ['Please listen ___ the full message.', ['to','at','for','on'], 0],
      ['A stranger came up ___ Hugo near the entrance.', ['to','for','with','on'], 0],
      ['Ivy looked ___ the schedule before leaving.', ['at','to','for','with'], 0],
      ['Theo is going out ___ his colleagues tonight.', ['with','to','for','at'], 0],
      ['Choose the natural phrase.', ['wait someone','wait for someone','wait to someone','wait at someone'], 1],
      ['Eva ___ to podcasts on her way to work.', ['listens','listens at','is listen','listening'], 0],
      ['The guide came up ___ us and offered help.', ['to','at','on','for'], 0],
      ['Which sentence is correct?', ['Look that painting.','Look at that painting.','Look to that painting.','Look for that painting now means see it.'], 1],
      ['Noah often goes out ___ friends on Saturday.', ['with','for','to','on'], 0],
      ['We are waiting ___ Lara outside the cinema.', ['for','at','to','of'], 0],
      ['Could you listen ___ this short recording?', ['to','with','for','at'], 0],
      ['The photographer looked ___ the light carefully.', ['at','to','for','on'], 0],
      ['A woman came up ___ Rafael after the talk.', ['to','with','for','at'], 0],
      ['Choose the correct sentence.', ['Zoe is going out with her cousins.','Zoe is going out to her cousins.','Zoe going with out cousins.','Zoe goes out her cousins.'], 0]
    ])
  },
  3: {
    ...CURRICULUM[3],
    title: 'Day 3: Mixed Review — Preferences & Descriptions',
    grammar: { title: '15-Question Mixed Review', desc: 'These preference patterns are already familiar. Complete the mixed set without another explanation.', rules: [] },
    grammarExercises: makeReview([
      ['Lina enjoys ___ historical novels.', ['read','reading','reads','to reading'], 1],
      ['Marco cannot stand ___ in long queues.', ['wait','waiting','waits','to waiting'], 1],
      ['We do not mind ___ early.', ['leaving','leave','left','to leaving'], 0],
      ['Tessa loves ___ photographs outdoors.', ['taking','take','took','to taking'], 0],
      ['A person who shares freely is ___.', ['generous','jealous','arrogant','sensitive'], 0],
      ['Arda hates ___ in heavy traffic.', ['driving','drive','drove','to driving'], 0],
      ['Choose the correct sentence.', ['I enjoy to cook.','I enjoy cooking.','I enjoying cook.','I enjoy cook.'], 1],
      ['Someone who becomes upset easily may be ___.', ['sensitive','energetic','confident','easy-going'], 0],
      ['Nadia likes ___ time with her grandparents.', ['spending','spend','spent','to spending'], 0],
      ['The speaker was sure of her ideas and answered clearly. She was ___.', ['confident','jealous','silly','annoying'], 0],
      ['Eren dislikes ___ paperwork late at night.', ['doing','do','does','to doing'], 0],
      ['Which phrase is neutral?', ["don’t mind","can’t stand",'hate','be crazy about'], 0],
      ['A person who thinks they are more important than everyone else is ___.', ['arrogant','honest','polite','generous'], 0],
      ['The twins love ___ music together.', ['making','make','made','to making'], 0],
      ['Choose the natural sentence.', ['Sara does not mind helping.','Sara does not mind help.','Sara not mind helping.','Sara is mind helping.'], 0]
    ])
  },
  4: {
    ...CURRICULUM[4],
    title: 'Day 4: New Rule — Verb + Preposition Partnerships',
    grammar: {
      title: 'New Rule: Learn the Whole Phrase',
      desc: 'Bu dersteki yeni kural şudur: bazı fiiller belirli bir edatla birlikte kullanılır. Fiili tek başına değil, edatıyla beraber bir kalıp olarak öğren.',
      rules: [
        { label: 'listen to / look at / wait for', text: 'Dinlemek, bakmak ve beklemek fiilleri bu anlamlarda sabit bir edat ister.', example: 'Marta listens to the guide, looks at the map and waits for her friend.' },
        { label: 'come up to / go out with', text: 'Birine yaklaşmak için come up to; biriyle sosyal olarak dışarı çıkmak için go out with kullanılır.', example: 'A man came up to Felix while he was going out with friends.' },
        { label: 'spend time on / talk to or with', text: 'Bir işe zaman ayırırken on; biriyle konuşurken to veya with kullanılır.', example: 'Priya spends time on the report and talks to her manager.' }
      ]
    },
    grammarExercises: makeReview([
      ['Jonas listens ___ the news every morning.', ['to','at','for','with'], 0],
      ['Kim looked ___ the wedding photographs.', ['at','to','for','on'], 0],
      ['A reporter came up ___ Elena after the event.', ['to','with','for','at'], 0],
      ['Ravi is going out ___ his cousins tonight.', ['with','to','for','on'], 0],
      ['We waited ___ the final decision.', ['for','to','with','at'], 0],
      ['Cem spends a lot of time ___ his new project.', ['on','to','for','with'], 0],
      ['Paula needs to talk ___ the clinic manager.', ['to','on','for','at'], 0],
      ['Choose the correct phrase.', ['listen a podcast','listen to a podcast','listen at a podcast','listen for a podcast means play it'], 1],
      ['Choose the correct sentence.', ['Ava looked at the screen.','Ava looked the screen.','Ava looked to the screen.','Ava at looked the screen.'], 0],
      ['The host came up ___ the guests to welcome them.', ['to','on','for','with'], 0],
      ['Leo often goes out ___ people from his office.', ['with','to','for','at'], 0],
      ['Mira is waiting ___ a file from the design team.', ['for','on','to','with'], 0],
      ['The team spent three hours ___ the presentation.', ['on','to','for','at'], 0],
      ['Which sentence is also correct?', ['I talked with Daniel.','I talked Daniel.','I talked at Daniel.','I talked for Daniel means with him.'], 0],
      ['Choose the complete partnership.', ['spend time on','spend time to','spend time at','spend on time with'], 0]
    ])
  }
};
...
export default function App() {
  ...
  for (let i = 1; i <= currentDay; i++) {
    cumulativeVocab.push(...CURRENT_CURRICULUM[i].vocab);
  }

  const dayData = {
    ...CURRENT_CURRICULUM[currentDay],
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between mb-6">
            <div className="flex items-center gap-3 mb-4 md:mb-0">
              ...
              <h1 className="text-2xl font-bold tracking-tight">Four-Day English Review</h1>
            </div>
            <p className="text-blue-100 text-sm md:text-base font-medium">Mixed review first · New rules on Day 4</p>
          </div>
